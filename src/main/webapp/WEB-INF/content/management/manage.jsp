			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12"  style="background-color: #FCFCFC">
					<div style="text-align:right;padding-top:10px;">
							当前位置：<a href="../index">首页</a><small>>>${manage.path}</small>
						</div><hr>
					<div class="row" >
						<div class="col-lg-3 col-xm-12 col-md-12 col-xs-12" >
							...
							<ul class="nav nav-pills nav-stacked" >
									...
									<li role="presentation"><a href="${manage.two_url}"><span class="glyphicon glyphicon-chevron-right"></span>更新内容</a></li>
								</ul>
							<div style="color: #F8F5F5">
							...
							<ul class="nav nav-pills nav-stacked" >
								...
								<li role="presentation"><a href="${manage.for_url}"><span class="glyphicon glyphicon-chevron-right"></span>上传文件</a></li>
								<li role="presentation"><a href="http://localhost:8090/fkbookapp/management/PicUpdate"><span class="glyphicon glyphicon-chevron-right"></span>上传图片</a></li>
							</ul>
						</div> --%>
									...
									<ul class="nav" id="side-menu">
										...
										<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
											...
											<ul class="nav nav-second-level">
												<li><a href="#">模块内容</a></li>
												<li><a href="${manage.two_url}">更新内容</a></li>
										...
										<li><a href="#"><i class="fa fa-wrench fa-fw"></i>
											...
											<ul class="nav nav-second-level">
												<li><a href="#">文件浏览</a></li>
												<li><a href="${manage.for_url}">上传文件</a></li>
												<li><a href="http://localhost:8090/fkbookapp/management/PicUpdate">上传图片</a></li>
